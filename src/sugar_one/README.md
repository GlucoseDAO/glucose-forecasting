...
`src/sugar_one/evaluate_model.py` is registered as **`uv run evaluate-model`**.
...
For GluMind-specific Hugging Face download and Livia sanity checks, see `src/glumind/README.md`.
