...
from common.checkpoint import load_full_checkpoint as _common_load_full_checkpoint
from common.checkpoint import save_full_checkpoint as _common_save_full_checkpoint
from common.checkpoint import update_latest_symlink as _common_update_latest_symlink
...
from common.data import SugarJepaWindowDataset  # noqa: E402  — re-export for train/eval callers
...
def main(
    ...
    jepa_weights_dir: str = typer.Option(
        "src/sugar_jepa/pretrained/cgm_jepa",
    ...
    out_dir: Path = typer.Option(DEFAULT_RUNS_ROOT / "sugar_jepa", help="Output directory."),
) -> None:
