...
The idea is that we use ClaudeCode and Cursor to write the manuscript. To let it have the context we make it in this ( https://github.com/GlucoseDAO/glucose-forecasting ) repository and we also add other relevant repositories to the cursor/vscode workspace. 
In particular:
* https://github.com/GlucoseDAO/glucose_data_processing for data processing
* https://github.com/GlucoseDAO/cgm_format for processing individual sensor information (optional)
* https://github.com/GlucoseDAO/sugar-sugar to tell about the glucose prediction game (optional)
