...
def fig_training_curve() -> None:
    ...
    fig.savefig(OUT_DIR / "fig_training_curve.png")
    plt.close(fig)
...
def fig_per_cohort_mae():
    ...
    fig.savefig(OUT_DIR / "fig_per_cohort_mae.png")
    plt.close(fig)
...
def fig_overall_t2dm():
    ...
    plt.tight_layout()
    fig.savefig(OUT_DIR / "fig_overall_t2dm.png")
    plt.close(fig)
...
def fig_overall_t1dm():
    ...
    plt.tight_layout()
    fig.savefig(OUT_DIR / "fig_overall_t1dm.png")
    plt.close(fig)
...
def fig_error_gradient():
    ...
    fig.savefig(OUT_DIR / "fig_error_gradient.png")
    plt.close(fig)
...
def fig_improvement_heatmap():
    ...
    fig.savefig(OUT_DIR / "fig_improvement_heatmap.png")
    plt.close(fig)
...
def fig_architecture():
    ...
    fig.savefig(OUT_DIR / "fig_architecture.png")
    plt.close(fig)
...
def fig_checkpoint_metrics():
    ...
    fig.savefig(OUT_DIR / "fig_checkpoint_metrics.png")
    plt.close(fig)
