...
Default config: scripts/personalization/personalization_tune.toml

Examples:
  uv run tune-personal
  uv run tune-personal -c scripts/personalization/personalization_tune_window_stride.toml
...
from scripts.personalization.constants import DEFAULT_PERSONAL_LWF_LAMBDA, DEFAULT_TRAIN_WINDOW_STRIDE
...
def main(
    config: Optional[Path] = typer.Option(
        ...
        "--config",
        "-c",
        help="TOML config (default: scripts/personalization/personalization_tune.toml).",
    ),
