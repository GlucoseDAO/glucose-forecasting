...
``scripts/common`` holds only the Protocol / registry. Each model package
implements a concrete spec (e.g. ``scripts/sugar_one/sugar_one_spec.py``).
...
from scripts.common.scalers import ScalerLike
...
_FAMILY_LAZY_IMPORTS: dict[str, str] = {
    "glumind": "scripts.glumind.glumind_spec:GLUMIND_SPEC",
    "sugar_one": "scripts.sugar_one.sugar_one_spec:SUGAR_ONE_SPEC",
    "glumind_uni": "scripts.glumind_uni.glumind_uni_spec:GLUMIND_UNI_SPEC",
    "sugar_jepa": "scripts.sugar_jepa.sugar_jepa_spec:SUGAR_JEPA_SPEC",
}
